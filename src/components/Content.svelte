...
<div>
	...
	>
		<div>
			...
			<button class="py-2 px-4 bg-blue-700 rounded-2xl"> Start free trial </button>
		</div>
		<img
	...
	<div class="p-4 font-normal rounded-2xl" style="background-color: rgb(146 151 179 / 13%)">
		<div class="flex justify-end pb-2 mb-6 border-b border-gray-600">
			<div class="mr-auto flex">
				<svg viewBox="0 0 52 52" class="w-7 h-7 rounded mr-4" style="border: 1px solid #3291b8">
		...
		<div class="flex justify-end pb-2 mb-6 border-b border-gray-600">
			<div class="mr-auto flex">
				<svg viewBox="0 0 52 52" class="w-7 h-7 rounded mr-4" style="border: 1px solid #b65a0b">
					<g xmlns="http://www.w3.org/2000/svg">
						<path
							d="M40.824 52H11.176C5.003 52 0 46.997 0 40.824V11.176C0 5.003 5.003 0 11.176 0h29.649C46.997 0 52 5.003 52 11.176v29.649C52 46.997 46.997 52 40.824 52z"
							fill="#261400"
